...
struct Light {
    ...
    static Light* newAmbientLight(vec3 position, vec3 color, float intensity);
    static Light* newDirectionalLight(vec3 direction, vec3 color, float intensity);
    static Light* newPointLight(vec3 origin, vec3 color, float intensity);
